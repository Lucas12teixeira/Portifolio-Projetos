...
* O uso de linguagem ou imagens sexualizadas, e atenção ou investidas
...
estejam alinhadas com este Código de Conduta, e comunicarão os motivos das decisões de moderação
quando apropriado.
...
postagem por meio de uma conta oficial de mídia social, ou atuação como representante
...
comunicação pública com a comunidade por um período de tempo especificado. Nenhuma interação
...
incluindo comportamento inadequado sustentado, assédio de um
indivíduo, ou agressão ou desprezo de classes de indivíduos.
...
**[⬆ Voltar ao Topo](#código-de-conduta-do-contribuidor)**

**[📚 Documentação Principal](README.md)** | **[🇺🇸 English Version](../en/CODE_OF_CONDUCT.md)**
